...
d3.json("json/source.json", function(sourceData){
    gen_legend();
});
...
x.domain(orders.name);
    ...
    function row(row) {
        ...
        d3.json("json/source.json", function(sourceData){
            if(sourceData.displayMethod == "significance level mining" 
                || sourceData.displayMethod == "significance level mining baseline" 
                || sourceData.displayMethod == "significance level mining with pruning"
                || sourceData.displayMethod == "significance level mining with boxing"){
                cell.append("svg:title").text(function(d){
                    return "significance level: " + d.label;
                });
            }else if(sourceData.displayMethod == "distance calculation"){
                cell.append("svg:title").text(function(d){
                    return "distance: " + d.label;
                });
            }
        });
